# Based on https://github.com/nh2/static-haskell-nix/blob/bd66b86b72cff4479e1c76d5916a853c38d09837/static-stack2nix-builder-example/default.nix
# Run using:
#
...
let
  cabalPackageName = "ODPServer";
  compiler = "ghc921"; # matching stack.yaml
  ...
  stack2nix-script = import "${static-haskell-nix}/static-stack2nix-builder/stack2nix-script.nix" {
    ...
    hackageSnapshot = "2021-12-22T00:00:00Z"; # pins e.g. extra-deps without hashes or revisions
  };
